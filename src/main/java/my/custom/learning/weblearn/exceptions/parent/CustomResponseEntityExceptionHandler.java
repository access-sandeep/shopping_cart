...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler({UserNotFoundException.class, PostNotFoundException.class, AddressNotFoundException.class, ProductNotFoundException.class, CategoryNotFoundException.class, BrandNotFoundException.class, WarehouseNotFoundException.class, ProductInventoryNotFoundException.class})
